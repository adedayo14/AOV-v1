          ...
          ${this.cart.items.map((item, index) => `
            <div class="cartuplift-item" data-variant-id="${item.variant_id}" data-line="${index + 1}">
              ...
              <div class="cartuplift-item-details">
                ...
                <div class="cartuplift-item-quantity">
                  <input type="number" class="cartuplift-quantity-input" value="${item.quantity}" min="0" data-line="${index + 1}" data-variant-id="${item.variant_id}">
                  <button class="cartuplift-remove-btn" data-line="${index + 1}" data-variant-id="${item.variant_id}">Remove</button>
                </div>
              </div>
            </div>
          `).join('')}
