  ...
  class CartUpliftDrawer {
    ...
    enforceSettings() {
      ...
      if (!this.settings.enableStickyCart) {
        ...
        if (stickyCart) {
          stickyCart.remove();
          console.log('🛒 Enforced removal of sticky cart');
        }
        
        // Also remove any that might exist with different selectors
        document.querySelectorAll('.cartuplift-sticky').forEach(el => {
          el.remove();
          console.log('🛒 Removed sticky cart with class selector');
        });
      }
    ...
    startSettingsMonitoring() {
      ...
      // Monitor settings every 2 seconds to ensure they are respected
      setInterval(() => {
        ...
        if (!this.settings.enableStickyCart) {
          ...
          if (stickyCart) {
            stickyCart.remove();
            console.log('🛒 Removed sticky cart via monitoring');
          }
        }
