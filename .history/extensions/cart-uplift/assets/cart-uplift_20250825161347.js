    ...
    getHeaderHTML(itemCount) {
      ...
      return `
        <div class="cartuplift-header-top">
          <div class="cartuplift-header-row" style="display: grid; grid-template-columns: 1fr 2fr 1fr; align-items: center; gap: 10px;">
            <div class="cartuplift-header-left">
              <h3 class="cartuplift-title text-xs font-medium uppercase">CART (${itemCount})</h3>
            </div>
            <div class="cartuplift-header-center" style="text-align: center;">
            ...
            <div class="cartuplift-header-right" style="text-align: right;">
