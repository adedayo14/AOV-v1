    ...
    getHeaderHTML(itemCount) {
      ...
      return `
        <div class="cartuplift-header-top">
          <div class="cartuplift-header-row" style="display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: 15px; width: 100%;">
            ...
            <div class="cartuplift-header-right" style="justify-self: end; margin-left: auto;">
              <button class="cartuplift-close cursor-pointer" aria-label="Close cart" style="margin-left: auto; display: block;">
