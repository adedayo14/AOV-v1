(function() {
  ...
  class UpCartDrawer {
    ...
    updateDrawerContent() {
      ...
      if (!itemsContainer || !this.cart) {
        console.log('🛒 No items container found or no cart data');
        return;
      }
      ...
      // Show items list
      console.log('🛒 Rendering cart items:', this.cart.items.length);
    ...
    openDrawer() {
      ...
      if (container) {
        ...
        // Update drawer content before opening
        this.updateDrawerContent();
