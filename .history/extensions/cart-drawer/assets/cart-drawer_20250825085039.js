(function() {
  ...
  class CartUpliftDrawer {
    ...
    openDrawer() {
      ...
      const popup = container.querySelector('#cartuplift-cart-popup');
      if (!popup || !popup.querySelector('.cartuplift-cart')) {
        popup.innerHTML = this.getDrawerHTML();
        this.attachDrawerEvents();
        this.loadOrderNotes();
      }
      ...
      const backdrop = container.querySelector('#cartuplift-backdrop');
      const drawer = container.querySelector('.cartuplift-cart');
      ...
      // Immediately remove any theme-applied blur/overlay classes after open
      ['js-drawer-open','drawer-open','modal-open'].forEach(cls => {
    ...
    closeDrawer() {
      ...
      const finishClose = () => {
        ...
        document.documentElement.classList.remove('upcart-drawer-open');
    ...
    forceCleanThemeArtifacts() {
      ...
      // Force clear any potential filter/blur styles
      const mainContent = document.querySelector('main') || document.querySelector('#MainContent') || document.querySelector('.main-content');
      if (mainContent) {
        mainContent.style.filter = '';
        mainContent.style.webkitFilter = '';
