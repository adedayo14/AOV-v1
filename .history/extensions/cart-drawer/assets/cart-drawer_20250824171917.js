(function() {
  ...
  class UpCartDrawer {
    ...
    overrideShopifyCartFunctions() {
      ...
      // Also override window.location changes
      ...
      Object.defineProperty(window, 'location', {
        ...
        set: function(val) {
          if (val && val.includes && val.includes('/cart') && window.UpCart && window.UpCart.isOpen && !isOverriding) {
            console.log('🛒 Blocked window.location change to cart page while drawer is open:', val);
            return;
          }
          if (!isOverriding) {
            isOverriding = true;
    ...
    createDrawer() {
      ...
      container.remove = function() {
        console.log('🛒 Attempt to remove drawer blocked!');
