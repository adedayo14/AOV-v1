...
export default function CartDrawerSettings() {
  ...
  return (
    <Page fullWidth>
      ...
      {isSuccess && (
        <Banner tone="success" onDismiss={() => fetcher.data = undefined}>
              ...
              <BlockStack gap="500">
                    ...
                    <Grid.Cell key={index} columnSpan={{xs: 6, md: 3}}>
                      <Card>
                        <BlockStack gap="200">
                          ...
                          <Text variant="bodyMd" tone="subdued">{stat.title}</Text>
                        </BlockStack>
                      </Card>
                    </Grid.Cell>
                  ))}
                ...
                <Card>
                  <BlockStack gap="400">
                    ...
                    <BlockStack gap="200">
                      <Text variant="bodyMd">1. Go to your theme editor</Text>
                      <Text variant="bodyMd">2. Click on "App embeds" in the left sidebar</Text>
                      <Text variant="bodyMd">3. Find "UpCart Cart Drawer" and toggle it on</Text>
                      <Text variant="bodyMd">4. Configure your settings in the Settings tab</Text>
                      <Text variant="bodyMd">5. Save your theme</Text>
                    </BlockStack>
                  </BlockStack>
                </Card>
              </BlockStack>
