(function() {
  ...
  class UpCartDrawer {
    ...
    createDrawer() {
      ...
      if (container) {
        console.log('🛒 Container already exists, populating with content...');
        // Check if it's empty (from app-embed.liquid)
        const cartPopup = container.querySelector('#upcart-cart-popup');
        if (cartPopup && cartPopup.innerHTML.trim() === '') {
          console.log('🛒 Populating empty cart popup with content...');
          cartPopup.innerHTML = `
      ...
      console.log('🛒 Drawer container ready');
    ...
    openDrawer() {
      ...
      if (container) {
        ...
        // Remove any inline display style that might be hiding the container
    ...
    closeDrawer() {
      ...
      if (container) {
        ...
        // Set display back to none when closing
