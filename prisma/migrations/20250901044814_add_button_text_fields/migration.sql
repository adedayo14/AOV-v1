...
INSERT INTO "new_Settings" ("actionText", "autoOpenCart", "backgroundColor", "buttonColor", "buttonTextColor", "cartIcon", "cartPosition", "complementDetectionMode", "createdAt", "enableAddons", "enableAnalytics", "enableApp", "enableDiscountCode", "enableExpressCheckout", "enableFreeShipping", "enableNotes", "enableRecommendations", "enableStickyCart", "freeShippingAchievedText", "freeShippingText", "freeShippingThreshold", "id", "manualRecommendationProducts", "maxRecommendations", "recommendationLayout", "recommendationsBackgroundColor", "recommendationsTitle", "shop", "showOnlyOnCartPage", "textColor", "updatedAt") SELECT "actionText", "autoOpenCart", "backgroundColor", "buttonColor", "buttonTextColor", "cartIcon", "cartPosition", "complementDetectionMode", "createdAt", "enableAddons", "enableAnalytics", "enableApp", "enableDiscountCode", "enableExpressCheckout", "enableFreeShipping", "enableNotes", "enableRecommendations", "enableStickyCart", "freeShippingAchievedText", "freeShippingText", "freeShippingThreshold", "id", "manualRecommendationProducts", "maxRecommendations", "recommendationLayout", "recommendationsBackgroundColor", "recommendationsTitle", "shop", "showOnlyOnCartPage", "textColor", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
